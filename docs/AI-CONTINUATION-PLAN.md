...
## Agente en idle (producto)

Ver **[ROADMAP.md](./ROADMAP.md)** — objetivo de compañero que percibe / decide / actúa en idle.

- **Nivel A:** `src/core/conversation/initiative.ts` + hook de iniciativa.
- **Nivel B (post 0.9.0):** plan JSON + whitelist (`noop`, `nudge`, `health_check`).
- Sin bucles ilimitados ni shell arbitrario en el primer corte.
